...
import FriendsAndBuyersList from 'components/cleanui/layout/FriendsAndBuyersList'
// import Advert from 'components/cleanui/layout/Advert'
    ...
    <div className={classNames({ cui__layout__grayBackground: isGrayBackground })}>
      ...
      >
        ...
        <Layout>
          ...
          <Breadcrumbs />
          <Layout.Content style={{ height: '100%', position: 'relative', marginTop:20 }}>
            <div className="cui__utils__content">
              <div className="row">
                <div className="col-md-3">
                  <FriendsAndBuyersList />
                </div>
