        ...
        <div className={style.logoContainer}>
          <div className={style.logo}>
            <Link to="/home">
              <img
                style={{
                  width: isMenuCollapsed && !isMobileView && 50,
                  height: isMobileView || (isMenuUnfixed && 50),
                }}
                src="/resources/images/menu-logo.png"
                className="mr-2"
                alt="estate plus"
              />
            </Link>
            {/* <div className={style.name}>{logo}</div> */}
            {/* {logo === 'Estate + Plus' && <div className={style.descr}>ES+</div>} */}
          </div>
        </div>
        <PerfectScrollbar>
          <Menu
          ...
          >
            {generateMenuItems()}
            <Menu.Item>
              <button className="btn btn-outline-primary rounded-3" type="button">Logout</button>
            </Menu.Item>
          </Menu>
